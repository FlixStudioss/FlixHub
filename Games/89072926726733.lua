...
TOGGLES[89072926726733] = {
    {label="Farm Brainrots", callback=function(on)
        if on then
            _G._BR_FARMBRAINROTS = true

            while _G._BR_FARMBRAINROTS do
    ...
    end, cleanup=function() _G._BR_FARMBRAINROTS = false end},

    {label="Remove Cars", isButton=true, callback=function()
        workspace.CarSpawn:Destroy()
    end}
}

print("[FlixHub] Game 89072926726733 toggles loaded")
